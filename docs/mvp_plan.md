...
a local-first, open-source review and curation platform. It is not a medical
advice tool and should not present treatment recommendations.
...
The MVP should validate the maintainer's private legacy bootstrap and enrich the
review workflow with candidate scientific publications discovered from January
2024 through the current date.
...
As of 2026-05-18, the active implementation contains the first local review surface for the MVP,
...
- legacy identity queue state: 1,206 total items, 1,206 open, 0 in review,
  0 resolved, and 0 dismissed.
