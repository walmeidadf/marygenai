...
from marygenai.classification.v4_models import V4PromptPacket
...
def test_build_v4_comparison_packets_is_local_versioned_and_fair(tmp_path: Path) -> None:
    ...
    assert report["selective_family_metrics"]["outcomes_direction"][
        "packets_without_evidence_candidates"
    ] == 5
